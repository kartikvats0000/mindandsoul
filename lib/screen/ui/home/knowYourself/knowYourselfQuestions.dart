...
class _KnowYourselfQuestionsState extends State<KnowYourselfQuestions> {
  ...
  getData()async{
    ...
    setState(() {
      preferNotToSay = user.languages[user.selectedLanguage]['custom_round_button_class']['prefer_not'] ?? user.languages['en']['custom_round_button_class']['prefer_not'];
    });
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: (){
                                  (finalAnswers[currentPage]['answers'].isNotEmpty)?Components(context).showErrorSnackBar(
                                    user.languages[user.selectedLanguage]['custom_round_button_class']['need_to_answer'] ?? user.languages['en']['custom_round_button_class']['need_to_answer'],
                                  ):
                                  pageController.nextPage(duration: const Duration(milliseconds: 300), curve: Curves.ease);
                                },
                                  child: Text(
                                    '${user.languages[user.selectedLanguage]['custom_round_button_class']['skip'] ?? user.languages['en']['custom_round_button_class']['skip']} →',
                             ...
                             showDialog(context: context, builder: (context) =>  Components(context).confirmationDialog(context,
                                 ...
                                 actions: [
                                   TextButton(onPressed: (){
                                     ...
                                     user.languages[user.selectedLanguage]['breathe_screen']['confim_cancel'] ?? user.languages['en']['breathe_screen']['confim_cancel'],
                                   )
                                   ),
                                   TextButton(onPressed: ()async{
                                     ...
                                     element['answers'] = element['answers'].where((e) => e['option'] != preferNotToSay).toList();
