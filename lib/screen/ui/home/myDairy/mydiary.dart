  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Container(
          ...
          child:  Row(
            ...
            children: [
              ...
              Text('Add new Entry',style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Colors.black),)
            ],
          ),
        ),
      ),
      appBar:AppBar(
        ...
        title: Text('My Diary',style: Theme.of(context).textTheme.displayLarge?.copyWith(color: Colors.black87,fontSize: 25),),
      ),
      body: (loading)
