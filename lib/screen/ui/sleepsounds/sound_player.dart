  ...
  void startTimer(int duration){
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), ((timer){
     ...
     Components(context).showSuccessSnackBar(
       user.languages[user.selectedLanguage]['custom_round_button_class']['timer_complete'] ?? user.languages['en']['custom_round_button_class']['timer_complete'],
     );
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                            user.languages[user.selectedLanguage]['custom_round_button_class']['set_timer'] ?? user.languages['en']['custom_round_button_class']['set_timer'],
                                                style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white),textAlign: TextAlign.start,),
                                          ...
                                          FilledButton(
                                            ...
                                            child: Text(
                                              user.languages[user.selectedLanguage]['custom_round_button_class']['start_timer'] ?? user.languages['en']['custom_round_button_class']['start_timer'],
                                            ),
                                          )
                                        ]
                                    ));
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text(''
                                                                    '${user.languages[user.selectedLanguage]['custom_round_button_class']['edit'] ?? user.languages['en']['custom_round_button_class']['edit']}'
                                                                    ' ${widget.data['title']}',style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white),textAlign: TextAlign.start,),
                                                                Components(context).BlurBackgroundCircularButton(icon: Icons.clear,iconSize: 17,buttonRadius: 17,iconColor: Colors.white70,onTap: ()=>Navigator.pop(context))
                                                              ],
                                                            ),
                                                          ),
                                                                  ...
                                                                  // minLeadingWidth: MediaQuery.of(context).size.width * 0.25,
                                                                    ...
                                                                    trailing: Components(context).BlurBackgroundCircularButton(svg: MyIcons.delete,onTap: (){
                                                                      if(audioplayers.length >1 ){
                                                                        ...
                                                                        Navigator.pop(context);
                                                                        Components(context).showErrorSnackBar(
                                                                          user.languages[user.selectedLanguage]['custom_round_button_class']['atleast_1_harmony'] ?? user.languages['en']['custom_round_button_class']['atleast_1_harmony'],
                                                                        );
                                                                      }
                  ...
                  bottom: 10,
                    ...
                    child: AnimatedOpacity(
                      duration: const Duration(milliseconds: 350),
                        ...
                        curve: Curves.ease,
                        child: Text(
                          user.languages[user.selectedLanguage]['custom_round_button_class']['harmony_player_message'] ?? user.languages['en']['custom_round_button_class']['harmony_player_message'],
                          style: Theme.of(context).textTheme.displayLarge?.copyWith(fontSize: 14,color: Colors.white),textAlign: TextAlign.center,)))
              ],
            ),
                   ),
         ),
